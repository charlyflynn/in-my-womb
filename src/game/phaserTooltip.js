...
export function addTooltip(x, y, item, content, scene) {
...
export class PhaserTooltip {
    ...
    createTooltip(options) {
        ...
        if (options.hasBackground) {
            ...
            if (options.content === undefined && options.html === undefined) {
                content.x =
                    background.rect.centerX - content.displayWidth * 0.5;
                content.y =
                    background.rect.centerY - content.displayHeight * 0.5;
            } else {
    ...
    getPadding(id) {
        ...
        var paddingBottom =
            this.tooltipCollection[id].options.paddingBottom || 12;
        var paddingLeft = this.tooltipCollection[id].options.paddingLeft || 16;
        var paddingRight =
            this.tooltipCollection[id].options.paddingRight || 16;
        return {
